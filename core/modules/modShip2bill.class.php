<?php
/* Copyright (C) 2013-2014 ATM Consulting <support@atm-consulting.fr>
 *
...
/**
 * 	\defgroup   ship2bill     Module Ship2bill
 *  \brief      Module permettant de regrouper plusieurs expéditions en une seule facture
 *  \file       htdocs/ship2bill/core/modules/modShip2bill.class.php
 *  \ingroup    ship2bill
 *  \brief      Description and activation file for module Ship2bill
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Ship2bill
 */
class modShip2bill extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->picto='ship2bill@ship2bill';
		...
		$this->dirs = array('/ship2bill');

		// Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
		$this->config_page_url = array("ship2bill_setup.php@ship2bill");
        ...
        */
		...
		$this->rights[$r][1] = 'Lire les expeditions facturables';	// Permission label
